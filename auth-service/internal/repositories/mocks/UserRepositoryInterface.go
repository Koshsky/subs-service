...
func (_m *UserRepositoryInterface) CreateUser(user *models.User) error {
	ret := _m.Called(user)
...
func (_m *UserRepositoryInterface) ValidateUser(email string, password string) (*models.User, error) {
